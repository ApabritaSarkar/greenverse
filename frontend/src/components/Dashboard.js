...
const Dashboard = () => {
  return (
    <div className="min-h-screen pt-16 bg-eco-offwhite font-inter">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-eco-green to-eco-blue text-white py-20 lg:py-32 px-4 md:px-8 flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 opacity-10 bg-[url('https://placehold.co/1200x800/FFFFFF/000000?text=Abstract+Leaf+Pattern')] bg-cover bg-center" />
        <div className="relative z-10 max-w-4xl text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            <Link
              to="/plants"
              className="bg-white text-eco-green px-8 py-3 rounded-lg shadow-lg hover:bg-gray-100 hover:shadow-xl transition-all font-semibold text-lg"
            >
              Explore Plant Varieties
            </Link>
            <Link
              to="/forum"
              className="border-2 border-white text-white px-8 py-3 rounded-lg hover:bg-white hover:text-eco-green transition-all font-semibold text-lg"
            >
      ...
      <section className="py-16 px-4 md:px-8 bg-eco-beige text-eco-dark rounded-xl mx-auto max-w-6xl my-12 shadow-lg">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-4xl font-bold mb-6 text-eco-green">About Us</h2>
      ...
      <section className="py-16 px-4 md:px-8 bg-eco-lightgreen bg-opacity-20 text-eco-dark">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-4xl font-bold text-center mb-10 text-eco-green">Contact Us</h2>
            ...
            <div className="w-full md:w-1/2 bg-white p-8 rounded-lg shadow-md">
              ...
              <form className="space-y-4">
                <input
                  ...
                  required
                  className="w-full p-3 border border-gray-300 rounded-md focus:ring-eco-green focus:border-eco-green transition-all text-eco-dark"
                />
                <input
                  type="email"
                ...
                <button
                  type="submit"
                  className="bg-gradient-to-r from-eco-green to-eco-blue text-white px-6 py-3 rounded-lg shadow-md hover:shadow-lg transition-all font-semibold w-full md:w-auto"
                >
                  Send Message
                </button>
              </form>
      ...
      <footer className="bg-eco-dark text-white py-8 px-4 text-center">
        <div className="max-w-6xl mx-auto">
          <p className="mb-2 text-sm md:text-base">
            &copy; 2024 Virtual Plant Companion. All rights reserved.
          </p>
          <p className="text-sm md:text-base">
            <Link to="/privacy-policy" className="hover:text-eco-lightgreen transition-colors">Privacy Policy</Link>
            <span className="mx-2">|</span>
            <Link to="/terms-of-service" className="hover:text-eco-lightgreen transition-colors">Terms of Service</Link>
          </p>
        </div>
      </footer>
    </div>
